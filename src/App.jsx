...
function App() {
  ...
  <div className="font-Inter">
    ...
    <div className="bg-slate-300 w-full h-full flex flex-row gap-20 justify-center items-center pt-5 pb-[60px]">
      <div className="w-[25rem] h-[28rem] bg-[#D9D9D9] drop-shadow-lg ">
      </div>

      <div className= "w-[25rem] h-[28rem] bg-white drop-shadow-lg px-5 flex flex-col">
        ...
        <button className="text-start text-base text-[#074173] hover:text-[#022c4f] text-sm pt-5">Não possui cadastro? Cadastre-se agora!</button>
      </div>
    </div>
  </div>
  );
